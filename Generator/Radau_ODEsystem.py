...
##                                      f.depdomain)))
        ...
        if int(Err) > 0:
            ...
            try:
                self.diagnostics.errors.append((E_COMPUTFAIL, (self._solver.lastTime,
            ...
            self.defined = False
            if self.diagnostics.outputStats['num_steps'] > self.algparams['max_pts']:
                print "max_pts algorithmic parameter too small: current value is %i"%self.algparams['max_pts']
