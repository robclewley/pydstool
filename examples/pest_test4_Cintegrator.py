...
plt.ylabel('v')
plt.xlabel('t')
goalline = plt.plot(plotData_goal['t'], plotData_goal['v'], label="v goal")
origline = plt.plot(plotData_orig['t'], plotData_orig['v'], label="v initial")
estline = plt.plot(plotData_par['t'], plotData_par['v'], label='v estimated')
