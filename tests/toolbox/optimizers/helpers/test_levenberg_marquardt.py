...
from PyDSTool.Toolbox.optimizers.helpers import LMQuadratic
...
class test_LinearFunction(unittest.TestCase):
  def setUp(self):
    ...
    self.y = 3*self.x+4
    self.function = LMQuadratic(self.x, self.y, F1())
...
class test_LinearFunction2D(unittest.TestCase):
  def setUp(self):
    ...
    self.function = LMQuadratic(self.x, self.y, F2())
...
class test_ExponentialFunction(unittest.TestCase):
  def setUp(self):
    ...
    self.function = LMQuadratic(self.x, self.y, Fexp())
