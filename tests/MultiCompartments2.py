...
pylab.figure()
vs1line = plot(v_dat['t'], v_dat['cell1.soma.V'], 'g')
vd1line = plot(v_dat['t'], v_dat['cell1.dend.V'], 'g--')
vs2line = plot(v_dat['t'], v_dat['cell2.soma.V'], 'r')
vd2line = plot(v_dat['t'], v_dat['cell2.dend.V'], 'r--')
show()
