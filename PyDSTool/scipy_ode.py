...
__all__ = ['ode']
__version__ = "$Id: ode.py,v 1.2 2003/12/13 13:44:49 pearu Exp $"

import scipy
from numpy import asarray, array, zeros, sin
import re, types, sys

# use this to replace a lambda expression in the vode calling code
def noneFn():
    return None
...
ode  - a generic interface class to numeric integrators. It has the
  ...
  where f and jac have the following signatures:
    ...
    def __init__(self,f,jac=None):
        ...
        self.jac_params = ()
        self.y = []
        self._integrator = None    # R.H.C. added
    ...
    def integrate(self,t,step=0,relax=0):
        ...
        self.y,self.t = mth(self.f,self.jac or noneFn,
                            self.y,self.t,t,
...
class vode(IntegratorBase):
    ...
    def reset(self,n,has_jac):
        # Calculate pars for Fortran subroutine dvode.
        if has_jac:
